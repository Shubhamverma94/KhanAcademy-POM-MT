...
import { AppiumServer, BaseDriverCapConstraints, Capabilities, Constraints, DefaultCreateSessionResult, Driver, DriverCaps, DriverData, DriverOpts, MultiSessionData, ServerArgs, StringRecord, W3CDriverCaps } from '@appium/types';
export declare class BaseDriver<C extends Constraints, CArgs extends StringRecord = StringRecord, Settings extends StringRecord = StringRecord, SessionData extends StringRecord = StringRecord> extends DriverCore<C, Settings> implements Driver<C, CArgs> {
     ...
     */
    getSession(): Promise<DriverCaps<C>>;
